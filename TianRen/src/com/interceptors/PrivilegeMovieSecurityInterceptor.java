...
public class PrivilegeMovieSecurityInterceptor extends MethodFilterInterceptor
{
    ...
    public void init() {
        super.init();
        System.out.println("\u5f71\u7247\u7ba1\u7406\u6743\u9650\u5b89\u5168\u62e6\u622a\u5668" + this.name + "\u521d\u59cb\u5316\u4e86\uff01");
    }
    
    public void destroy() {
        super.destroy();
        System.out.println("\u5f71\u7247\u7ba1\u7406\u6743\u9650\u5b89\u5168\u62e6\u622a\u5668" + this.name + "\u9500\u6bc1\u4e86\uff01");
    }
    
    protected String doIntercept(final ActionInvocation invocation) throws Exception {
        System.out.println("\u5f71\u7247\u7ba1\u7406\u6743\u9650\u5b89\u5168\u62e6\u622a\u5668" + this.name + "\u5de5\u4f5c\u4e86\uff01");
        ...
        if (admin.getAdminPrivilege().indexOf("1") != -1) {
